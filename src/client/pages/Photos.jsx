        ...
        <div className="photos">
            ...
            {!user ? (
                ...
                >
                    ...
                    <div className="mt-4">
                    <a href="https://accounts.google.com/o/oauth2/v2/auth?client_id=879762652639-ejv0ansll3pk68fl7psv60pichuacv16.apps.googleusercontent.com&redirect_uri=http://localhost:5000/auth/google/callback&response_type=code&scope=email%20profile">
                    Sign in with Google
                    </a>
