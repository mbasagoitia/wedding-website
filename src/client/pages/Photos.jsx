...
const Photos = () => {
    ...
    return (
        ...
        <div>
            ...
            <a href="https://accounts.google.com/o/oauth2/v2/auth?client_id=879762652639-0va910evds26g88gpals8q1v210keln1.apps.googleusercontent.com&redirect_uri=https://wedding.basagoitia.net/auth/google/callback&response_type=code&scope=email%20profile"><button>Link Google Account/Sign in</button></a>
        </div>
