...
const Photos = () => {
    ...
    return (
        ...
        <div className="photo-preview-section d-flex justify-content-evenly">
            ...
            <PhotoPreviews title={"Ceremony (Coming soon)"} link = {"#"} photo1={"/images/placeholder-image.jpg"} />
            <PhotoPreviews title={"Reception (Coming soon)"} link = {"#"} photo1={"/images/placeholder-image.jpg"} />
            <PhotoPreviews title={"Other (Coming soon)"} link = {"#"} photo1={"/images/placeholder-image.jpg"} />
        </div>
        </Container>
    )
}
